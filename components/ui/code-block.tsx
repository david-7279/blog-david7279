...
const BunIcon = (p: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fillRule="evenodd"
      d="M25.7 38.8a5.51 5.51 0 1 0-5.5-5.51 5.51 5.51 0 0 0 5.51 5.51Zm24.77 0A5.51 5.51 0 1 0 45 33.29a5.5 5.5 0 0 0 5.47 5.51Z"
    />
    <path
      fill="#fff"
      fillRule="evenodd"
      d="M24 33.64a2.07 2.07 0 1 0-2.06-2.07A2.07 2.07 0 0 0 24 33.64Zm24.77 0a2.07 2.07 0 1 0-2.06-2.07 2.07 2.07 0 0 0-2.06 2.07 2.07 0 0 0 2.04 2.07Z"
    />
    <path
      fill="#b71422"
...
interface CodeBlockProps {
  ...
  /**
   * Tailwind class(es) applied to the code body.
   *
   * Example:
   * `bg-muted`
   * `bg-slate-950`
...
async function renderCode(
  ...
  return codeToHtml(code, {
    ...
    /**
     * Let CSS control the active theme instead of hard-coding
     * one color into the generated HTML.
     *
     * Shiki exposes:
     * --shiki-light
     * --shiki-dark
    ...
    transformers: [
      {
        /**
         * Remove Shiki's generated background from the <pre>.
         *
         * The actual background is controlled by the CodeRenderer
         * using Tailwind (`bg-muted` by default).
         *
         * Important:
         * We intentionally DO NOT remove --shiki-light or
         * --shiki-dark because those variables are required
         * by globals.css for theme switching.
         */
        pre(node) {
        ...
        /**
         * Add a semantic class to highlighted lines.
         */
        line(node, line) {
...
function CodeRenderer({
  ...
  useEffect(() => {
    ...
    renderCode(code, language, highlightLines).then((result) => {
      if (!cancelled) {
        setHtml(result);
      }
    });
...
export function LanguageTabsCodeBlock({
  ...
  const tab = tabs.find((item) => item.label === active) ?? tabs[0];
